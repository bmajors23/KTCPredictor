...
# Loop through pages
for page in range(0, 1):  # Adjust the range as needed
...
# Save to CSV
df.to_csv("dynasty_rankings_with_tep.csv", index=False)

print("Scraping complete! Data saved to 'dynasty_rankings_with_tep.csv'.")
